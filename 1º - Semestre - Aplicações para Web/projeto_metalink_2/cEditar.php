...
<?php
    ...
    if (empty($_POST)) { // Verifica se o array $_POST está vazio. Se estiver, significa que a página foi acessada diretamente e não via formulário.
        header("Location: editar.php?id=" . $_GET['idusuario']); // Redireciona para a página editar.php com o ID do usuário na URL.
    ...
    # VERIFICAR RESULTADO
        ...
        header("Location: inicio.php?m=$nome"); // Redireciona para a página listar_usuario.php com a mensagem de sucesso na variável $msg.
