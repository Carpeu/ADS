...
<head>
    ...
    <style>
        ...
        .logout-btn a {
            width: 30%;
            padding: 10px;
            background-color: #dc3545; /* Altera a cor de fundo para vermelho */
            border: none;
            color: #fff;
            border-radius: 5px;
            cursor: pointer;
        ...
        .logout-btn a:hover {
            background-color: #c82333; /* Altera a cor de fundo ao passar o mouse */
        }
    </style>
</head>
<body>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group mt-4">
                            <li class="list-group-item">
                                <a href="links.php?idusuario=<?php echo $arResultado['idusuario']; ?>" class="btn btn-success">Cadastrar Link</a>
                            </li>
                            <li class="list-group-item">
                                <a href="enviar_links.php?idusuario=<?php echo $arResultado['idusuario']; ?>" target="_blank" class="btn btn-primary">Enviar links</a>
                            </li>
                            <li class="list-group-item">
                                <a href="listar_links.php" class="btn btn-secondary">Listar Links Criados</a>
                            </li>
                            <li class="list-group-item">
                        ...
                        <div class="text-center logout-btn">
                            <a href="logout.php" class="btn btn-danger" onclick="return confirm('Tem certeza que deseja sair?')">Sair</a>
                        </div>
                    </div>
                </div>
            </div>
