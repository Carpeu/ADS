...
$sql = "SELECT * FROM links WHERE Usuario_idUsuario = $idUsuario";
    ...
    <div class="link-container">
        ...
        ?>
                <div class="link-card">
                    ...
                    <a href="excluir_link.php?id=<?php echo $row['idLinks']; ?>" class="delete-link" onclick="return confirm('Tem certeza que deseja excluir este link?')">Excluir</a>
                </div>
